...
from validate_vs_frontier import validate_against_frontier
...
# === Logger + Simulazione portafoglio ottimizzato
logger = PortfolioLogger(save_dir=results_dir)
portfolio_series = simulate_portfolio(df_prices, df_mu, df_sigma, rebal_dates,
...
if os.path.exists(rl_path):
    ...
    print("⚠️ RL policy non trovata, salta confronto.")

# === Validazione rispetto alla frontiera
